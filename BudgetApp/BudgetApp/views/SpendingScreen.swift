...
struct SpendingScreen: View {
    ...
    var chartData = ["Monthly" : [SavingsDataPoint(month: "May", value: 4000),
                     ...
                     "Daily" : [SavingsDataPoint(month: "May", value: 4000),
                                SavingsDataPoint(month: "Jun", value: 9850),
                                SavingsDataPoint(month: "Jul", value: 6570),
                                SavingsDataPoint(month: "Aug", value: 5400),
                                SavingsDataPoint(month: "Sep", value: 6000),
                                SavingsDataPoint(month: "Oct", value: 4800)]]
        ...
        VStack(alignment: .leading) {
            ...
            ScrollView {
                ...
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    Text("Indian Bank, 133/2, Trichy road, Coimbatore")
